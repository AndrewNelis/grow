...
/* global parse: false, describe, it, expect, window, _, document, register */
'use strict';
...
describe("parse", function() {
    ...
    it("can parse a number with a float coefficient", function() {
        var fn = parse('.42e2');
        expect(fn()).toBe(42);
    });
    ...
    it("can parse upper case scientific notiation", function() {
        var fn = parse('.42E2');
        expect(fn()).toBe(42);
    });
    ...
    it("parses a function call with a single number present", function() {
    ...
    it('parses multiplicatives on a higher precidence than additives', function() {
