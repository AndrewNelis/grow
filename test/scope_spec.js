/* jshint strict: true */
/* global describe, it, Scope, expect, beforeEach, jasmine, _, setTimeout, document */
...
describe("Scope", function() {
    ...
    describe("digest", function() {
        ...
        it("calls the watch function with the scope as the first argument", function() {
        ...
        it("calls the listener function when the watch value is first undefined", function() {
            scope.counter = 0;
            scope.$watch(
                function(scope) { return scope.someValue; },
                function(newValue, oldValue, scope) { scope.counter++; }
        ...
        it("calls the listener with new value as old value the first time", function() {
            ...
            scope.$watch(
                function(scope) { return scope.someValue; },
                function(newValue, oldValue) { oldValueGiven = oldValue; }
            );
            scope.$digest();
            expect(oldValueGiven).toBe(123);
        });

        it("may have watchers that ommit the listener function", function() {
        ...
        it("does not end digest so that new watches are run", function() {
            scope.aValue = 0;
            scope.counter = 0;
            scope.$watch(
        ...
        it("catches exeptions in $applyAsync", function(done) {
    ...
    describe("$watchCollection", function() {
        ...
        it("notices an item replaced in a NodeList object", function() {
            // Here we fork from the book: Jasmine tests running in browser.
            var div = document.createElement('div');
            div.appendChild(document.createElement('div'));
            scope.arrayLike = div.getElementsByTagName('div');
            scope.counter = 0;
            scope.$watchCollection(
                function(scope) { return scope.arrayLike; },
                function(newValue, oldValue, scope) {
    ...
    describe("Events", function() {
        ...
        _.forEach(['$emit', '$broadcast'], function(method) {
            ...
            it("sets defaultPrevented when preventDefaul is called on " + method, function() {
